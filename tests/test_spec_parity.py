"""Parity guard for the domain spec (xbloom/spec.py).
...
def _checks():
    ...
    # Corrected 2026-07-20: temperature unit is 0=°F, 1=°C.
    # Deliberate exception #2: these were "C"/"F" pre-refactor, but a select's
    # state value doubles as a host's translation key, and hosts commonly
    # require [a-z0-9-_]+ and reject uppercase. The wire codes (1/0) are
    # unchanged; only the token case moved.
